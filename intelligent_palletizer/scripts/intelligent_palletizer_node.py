...
def move():
    ...
    count_ = 0
    offset_y = 0
    ## TODO 1: stack sequence initiallization
    stack_num = 0
    ##
    start_en = True
    ...
    while __isRunning:
        if steadier and object_center_x > 0 and object_center_y > 0: 
            ...
            if stack_en:
                ...
                rospy.sleep(1.5)
                ## TODO 3: set block placement sequence
                stack_num += 1 # place blocks with sequence 1,2,3
                ##
                ...
                if stack_num >= 3: # 码垛计量大于等于3，进行重置
                    stack_num = 0 # you may also need to change this, corresponding to your intial
